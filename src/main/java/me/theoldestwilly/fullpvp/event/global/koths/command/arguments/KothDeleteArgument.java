...
public class KothDeleteArgument extends CommandArgument {
    private final FullPvP plugin;

    public KothDeleteArgument(FullPvP plugin) {
        super("delete", "Deletes a koth.", new String[]{""});
        this.plugin = plugin;
        this.permission = "fullpvp.command.koth.argument.delete";
    }
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] arguments) {
        if (arguments.length != 2) {
            ...
            this.plugin.getGlobalEventsManager().getKothManager().onDeleteKoth((Player)sender, arguments[1]);
        } else {
