...
public class KothSetCapzoneArgument extends CommandArgument {
    private final FullPvP plugin;

    public KothSetCapzoneArgument(FullPvP plugin) {
        super("setcapzone", "", new String[]{""});
        this.plugin = plugin;
        this.permission = "fullpvp.command.koth.argument.setcapzone";
    }
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] arguments) {
        if (arguments.length != 2) {
            ...
            this.plugin.getGlobalEventsManager().getKothManager().onSetCapZone((Player)sender, arguments[1]);
        } else {
